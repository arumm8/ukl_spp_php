...
<body>
    ...
    <br>
    <h4 align="center" style="color: #801336;">Register Petugas</h4>
    <form action="proses_tambah_petugas.php" method="post">
        <input type="hidden" name="level" value="petugas" class="form-control mb-2">
        ...
        <a class="nav-link active" aria-current="page" href="login_petugas.php" style="color: #801336;">Back</a>
        <button class="nav-link active" aria-current="page" type="submit" style="color: #801336;"> Tambah Petugas </button>
    </form>
