...
<body style="background-color: #801336;">
    ...
    <div class="col-md rounded bg-light" style="box-shadow: 4px 4px 5px 4px;padding:10px;" >
        <form action="proses_login.php" method="post">
          <h3 align="center" style="color: #801336; margin-left:20px;">LOGIN</h3> <hr><br>
          <p style="margin-left:20px;">NISN :</p>
          <input type="text" name="nisn" value="" class="form-control"> <br>
          ...
          <center><h6>Belum mendaftar? <a href="tambah_siswa.php" style="color: #801336;">Daftar</a></h6></center>
      </form>
    </div>
    <div class="col-md"></div>
  </div>
